...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # iterate through results_dic processing each pet image with classifier function
    for file_name, value in results_dic.items():
        ...
        results_dic[file_name].extend([classifier_label, is_match])
        
        # print results for testing purposes
        try:
            if is_testing: 
                print(results_dic[file_name])
        except:
            pass
